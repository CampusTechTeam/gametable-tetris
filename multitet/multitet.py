...
from libavg import avg, Point2D, fadeOut, app, player
...
class Multitet(app.MainDiv):
    ...
    def onInit(self):
        ...
        self.create_button(self, player.stop, 'Exit', 1, exit_button_pos,
                'center')
    ...
    def create_game_over_box(self):
        ...
        self.create_button(box, player.stop, 'Exit', 1.6,
